...
if (isset($_GET['filtrar'])) {
  ...
  if (!empty($filtro) && !empty($valor)) {
    if ($filtro == "codigo") {
      ...
      $mysql_query .= " WHERE nome LIKE '%{$valor}%'";
    }
  }
}
...
<div class="container p-3">
  <header>
    <h2>Professores</h2>
    <p>Listagem de professores cadastrados.</p>
  </header>
  <hr>
  <section class="d-flex justify-content-between">
    <a href="insert-professor.php"><button type="button" class="btn btn-dark">Adicionar Professor</button></a>
    ...
    <tbody>
      ...
      <tr> 
        ...
        <td style="text-align:center">
          <a href="details-professor.php?codigo=<?php echo $data['codigo']; ?>">
